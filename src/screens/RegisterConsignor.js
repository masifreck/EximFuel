...
export default function RegisterConsignor({ onSuccess, onClose }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'https://exim.tranzol.com/api/LoadingChallan/CreateConsignor',
        {
          method: 'POST',
          headers: {
  ...
  return (
    <View style={styles.container}>
        <Text style={{fontSize:18, fontWeight:'bold', alignSelf:'center', marginBottom:10,color:'black'}}>Register New Consignor</Text>
      {/* Close button */}
